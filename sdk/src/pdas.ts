 ...
 * seeds = ["config"]
 */
export function configPda(programId: PublicKey = COLS_PROGRAM_ID): PdaResult {
...
export function petPda(
  kolOwner: PublicKey,
  kolName: Uint8Array,
  programId: PublicKey = COLS_PROGRAM_ID
): PdaResult {
 ...
 */
export function feeVaultPda(programId: PublicKey = COLS_PROGRAM_ID): PdaResult {
